...
class ZhihuSpider(Spider):
    ...
    def parse_question_page(self, response):
        ...
        topicUrl = response.meta["topic_url"]
        if topicUrl.find("https:") < 0:
        ...
        wenda["description"] = ""
        wenda["images"] = []
        wenda["source"] = originUrl
        wenda["username"] = ""
        wenda["headPortrait"] = ""
        wenda["askList"] = []
        wenda["addtime"] = ""
        wenda["topicUrl"] = topicUrl
    ...
    def parse_article_page(self, response):
        ...
        article["source"] = originUrl
        article["topicUrl"] = topicUrl
