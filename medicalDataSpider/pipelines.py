...
class MedicaldataspiderPipeline:
    ...
    def process_item(self, item, spider):
        if isinstance(item, KeywordItem):
            api = "https://spider-es-jx-api.jxivf.com/api/spider/setKeyword"
            ...
            api = "https://spider-es-jx-api.jxivf.com/api/spider/setBaike"
            ...
            api = "https://spider-es-jx-api.jxivf.com/api/spider/setNews"
            ...
            #     ItemAdapter(item).asdict())
            api = "https://spider-es-jx-api.jxivf.com/api/spider/setComment"
            ...
            api = "https://spider-es-jx-api.jxivf.com/api/spider/setAsk"
            ...
            api = "https://spider-es-jx-api.jxivf.com/api/spider/setHuati"
            ...
            #     ItemAdapter(item).asdict())
            api = "https://spider-es-jx-api.jxivf.com/api/spider/setHuatiContent"
